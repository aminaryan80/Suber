...
public class DriverProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        withdrawButton.setOnClickListener(view -> {
            Intent intent = new Intent(DriverProfileActivity.this, WithdrawActivity.class);
    ...
    private void loadProfileData() {
        ...
        @SuppressLint("SetTextI18n") StringRequest myRequest = new StringRequest(Request.Method.GET, url,
                ...
                error -> Toast.makeText(DriverProfileActivity.this, error.getMessage(), Toast.LENGTH_LONG).show()
        );
    ...
    private void updateProfile(String new_username, String firstname, String lastname) {
        try {
            ...
            jsonBody.put("user_type", "D");
            final String requestBody = jsonBody.toString();
            StringRequest myRequest = new StringRequest(Request.Method.PUT, url,
                    response -> {
                        Toast.makeText(DriverProfileActivity.this, "Profile Updated!", Toast.LENGTH_LONG).show();
